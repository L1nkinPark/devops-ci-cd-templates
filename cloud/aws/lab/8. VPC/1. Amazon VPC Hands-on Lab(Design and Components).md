...
Sơ đồ mô tả cách phân hoạch 4 subnets quy mô lớn hơn 1000 IPs (sử dụng dải CIDR `/22` tương ứng 1024 IPs) trên 2 Availability Zones, tích hợp Internet Gateway, NAT Gateway và S3 Endpoint:
